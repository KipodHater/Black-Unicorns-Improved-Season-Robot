...
import static frc.robot.subsystems.gripper.GripperConstants.GEAR_RATIO;
...
public class ArmIOSim implements ArmIO{
    ...
    public ArmIOSim() {
        ...
        armSim = new SingleJointedArmSim(LinearSystemId.createSingleJointedArmSystem(DCMotor.getNEO(2), ARM_MOI, 1/GEAR_RATIO)
    , DCMotor.getNEO(2), ARM_GEAR_RATIO, ARM_LENGTH_METERS, MIN_ANGLE, MAX_ANGLE, true, 60, 0.05);
    }

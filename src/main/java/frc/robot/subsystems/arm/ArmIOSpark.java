...
public class ArmIOSpark implements ArmIO{
    ...
    public ArmIOSpark() {
        ...
        config.encoder.positionConversionFactor(ArmConstants.POSITION_CONVERSION_FACTOR)
    ...
    @Override
    public void updateInputs(ArmIOInputes inputs){
        sparkStickyFault = false;

        ifOk(motor, armEncoder :: getPosition, (position) -> inputs.positionDeg = position);
